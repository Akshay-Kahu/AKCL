...
public class POM_Class1 {
	...
	@FindBy(xpath = "(//div[@class='xtXmba'])[9]")private WebElement Flight;
	
	@FindBy(xpath = "(//input[@type='text'])[1]")private WebElement Source;
	
	@FindBy(xpath = "(//input[@type='text'])[2]")private WebElement Destination;
	
	@FindBy(xpath = "(//input[@type='text'])[3]")private WebElement Date;
	
	@FindBy(xpath = "(//input[@type='text'])[5]")private WebElement Traveller;
