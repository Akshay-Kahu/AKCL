...
public class POM_Class3 {
	...
	@FindBy(xpath="//input[@title='Search grocery products'])") private WebElement Click_grocery;
	
	@FindBy(xpath="//input[@title='Search grocery products'])") private WebElement search_grocery;
	
	@FindBy(xpath="//button[@type='submit']")private WebElement click_button;
